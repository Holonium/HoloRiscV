...
HD_PWD='C:/Users/Holonium/Documents/HoloRiscV/Vivado/HoloRiscV/HoloRiscV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HoloRiscV.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HoloRiscV.tcl -notrace
